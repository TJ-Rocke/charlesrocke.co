...
export const article = {
  ...
  title: 'Twenty Five',
  description:
    "Things are beginning to make sense, I'm seeing my purpose. It isn't to slander, it isn't to waste time. I've got one focus, the worlds first black tech billionaire. Ambitious, yes, but it's all I've got left.",
}
