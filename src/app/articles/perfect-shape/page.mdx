...
export const article = {
  ...
  title: 'Perfect Shape',
  description:
    'Two more months until the new year. Eight weeks in the gym without fail, I wonder what I will look like in the end. Excited for the cold, ready to go as hard as a I can. Have a bullseye focus, no time for distractions. What about you?',
}
