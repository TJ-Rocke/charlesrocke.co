...
export const article = {
  ...
  title: '9',
  description:
    "Listening to Drake '9', I've been reflecting over the past year. I had several projects fail, made some terrible decisions, and felt like an imposter. My only foundation was staying in the gym. I made a decision last night that I would die for it. I'm back mentally and I'm coming for it.",
}
