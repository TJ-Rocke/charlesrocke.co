...
export const article = {
  ...
  date: '2023-10-01',
  title: 'Native Ambition',
  description:
    'Learning React Native and building custom applications. Will launch work tool suite to enhance productivity. Will be practicing and developing my sales skills. When my time comes it will be a home run. Ambition is native to me.',
}
