...
export const article = {
  ...
  title: 'Adrift at sea',
  description:
    "Been missing her lately. Deaths in the family left and right. I've been wondering if I'm really cut for leading a company. Should I give up? Will I make it? I've lost my focus, I've fallen off the horse. It's only a season, only a day of rain. A time to keep focus, to see what's through this curtain of pain.",
}
